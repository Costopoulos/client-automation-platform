"""Hybrid form parser: LLM-first with rule-based fallback"""
...
from app.parsers.rule_based.form_parser import RuleBasedFormParser

logger = structlog.get_logger()


class HybridFormParser(BaseParser):
    """
    Hybrid form parser that tries LLM extraction first, falls back to rule-based
    ...
    def parse(self, filepath: Path) -> Dict:
        """
        Parse form using hybrid strategy

"""Hybrid email parser: LLM-first with rule-based fallback"""
...
from app.parsers.rule_based.email_parser import RuleBasedEmailParser

logger = structlog.get_logger()


class HybridEmailParser(BaseParser):
    """
    Hybrid email parser that tries LLM extraction first, falls back to rule-based
    ...
    def parse(self, filepath: Path) -> Dict:
        """
        Parse email using hybrid strategy
